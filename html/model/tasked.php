...
function getTaskeds() {
    ...
    $vacations = R::getAll("SELECT `tasked`.`id`, `tasked`.`start`, `tasked`.`done_task` AS tasked_done, `tasked`.`user_id` AS tasked_user, `tasked`.`task_id`, 
`user`.`name` AS user_name, email, `user`.`weekdays` AS user_weekdays, 
