    ...
    <table class="table">
        ...
        <tbody>
            <?php foreach ( $vacations as $vacation ) { ?>
                <tr>
                    <td>
                        <?php echo (new DateTime($vacation->vacation->start))->format("d.m.y") ?>
                    </td>
                    <td>
                        <?php echo (new DateTime($vacation->vacation->end))->format("d.m.y") ?>
                    </td>
                    <td>
                        <?php echo $vacation->vacation->user_id?>
                    </td>
                    <td>
                        <?php echo $vacation->user->name ?>
                    </td>


                    <td>
                        <form method="POST">
                            <input type="hidden" value="<?php echo  $vacation->vacation->user_id ?>" name="id"/>
